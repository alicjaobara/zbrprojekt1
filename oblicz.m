function [X,Y,Z,fi,zn] = oblicz(kroki,xpocz,ypocz,zpocz,xkon,ykon,zkon,St,Ct,Sp,Cp,d1,d2,d5,l1,l2,l3,d,e,l4,l)
%funkcja do liczenia pozycji kolejnych punktów
X=zeros(kroki,8);
Y=zeros(kroki,8);
Z=zeros(kroki,8);
fi=zeros(kroki,5);
